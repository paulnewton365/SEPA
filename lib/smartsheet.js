...
const HEADLINE_FIELDS = {
  ...
  q16_d: "Understood to Not understood",
...
export async function submitToSmartsheet({ answers, submittedAt }) {
  ...
  if (columns[METADATA_COLUMNS.respondentName]) {
    cells.push({
      ...
      value: stringify(answers.respondent_name),
    });
  }
