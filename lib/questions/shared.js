      ...
      blocks: [
        {
          ...
          options:
            audience === "internal"
              ...
              : [
                  "SEPA member, utility",
                  "SEPA member, technology provider",
                  "Consumer advocate",
...
export const claritySection = {
  ...
  blurb:
    "SEPA has built real standing over more than a decade. This section is about making sure the language matches it, so what people say about SEPA is as strong as what SEPA does.",
  questions: [
    {
      id: "q5",
      prompt: "The one sentence.",
      helper:
        "How you describe SEPA, and how the sector describes it. Where those two differ is where the work is.",
      blocks: [
        {
          id: "q5_a",
          type: "text",
          label:
            "If you had to explain SEPA to a colleague in one sentence, what would you say?",
          placeholder: "Your own words, in plain language.",
          maxWords: 30,
        },
        {
          id: "q5_b",
          type: "text",
          label: "And how do you hear other people in the sector describe it?",
          placeholder: "However they put it, generous or not.",
          maxWords: 30,
        },
      ],
    },
    {
      id: "q6",
      prompt: "What do you wish more people understood about SEPA?",
      helper:
        "The thing that gets missed, undersold, or misread. The part you find yourself having to point out.",
      blocks: [
        {
          id: "q6_a",
          type: "text",
...
export const nameSection = (audience) => ({
  ...
  blurb:
    audience === "internal"
      ? "SEPA has built more than a decade of recognition under this name. The organization has also grown well beyond what \u201cSmart Electric\u201d describes, and a change of name is on the table. Before anyone weighs that up, we want to understand what the name is worth today. We're not asking for name suggestions here."
      : "SEPA has built more than a decade of recognition under this name, and the organization has grown a great deal in that time. As part of this work, a change of name is under consideration. No decision has been made. We want to understand what the current name is worth before anyone weighs that up. We're not asking for name suggestions here.",
  questions: [
    {
      id: "q8",
      prompt:
