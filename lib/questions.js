...
export const sections = [
    ...
    questions: [
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "text",
            label:
              "Would you say it differently to a regulator than to a utility? If so, how?",
            placeholder: "The version you'd use in that room.",
            maxWords: 30,
            optional: true,
          },
        ],
      ...
      {
        id: "q3",
        prompt: "If SEPA vanished overnight, what would actually be lost?",
        helper:
      ...
      },
      {
        id: "q4",
        prompt:
          "What does SEPA do differently from how anyone else would go at the same problem?",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "q6",
        prompt:
          "When this work is done right, what does someone on the outside finally understand?",
        helper: "Something they don't get today.",
        blocks: [
          {
            id: "q6_a",
            type: "text",
            label: "What they finally understand:",
    ...
    questions: [
      {
        ...
        helper: "Be specific. Whose recognition, in what room, at what moment.",
        blocks: [
          {
            id: "q8_a",
            type: "text",
      ...
      {
        id: "q9",
        prompt: "And the other side of it. Where has the name cost you?",
        helper:
  ...
  },
  {
    ...
    title: "Neutrality",
    blurb:
      "\u201cSEPA does not lobby\u201d currently reads like a limitation. We think it might be the opposite: the condition that makes everything else possible.",
    questions: [
      {
        id: "q11",
        prompt:
    ...
    questions: [
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "text",
            label:
              "The one detail from it a stranger would still remember a year later:",
            placeholder: "A single image, as specific as you can make it.",
            maxWords: 30,
            optional: true,
          },
        ],
  ...
  },
  {
    id: "s7",
    number: "07",
    title: "A line on paper",
    blurb:
      "We put something down before we'd heard any of this. We'd rather you tried to break it than agreed with it. Where it fails is more useful to us than where it lands.",
    questions: [
      {
        id: "q14",
        prompt: "\u201cLet's shape energy's transition.\u201d",
        helper:
          "Read it once, react, then explain the reaction. Don't be polite about it.",
        blocks: [
          {
            id: "q14_a",
            type: "single_select",
          ...
          },
          {
            ...
            type: "text",
            label:
              "Where does it not survive contact with how SEPA actually works?",
            placeholder: "The word that catches, or the promise that overreaches.",
            maxWords: 40,
          },
        ],
      },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        helper:
          "Members have the most to lose in a rebrand and the least visibility into why it's happening.",
        blocks: [
          {
            id: "q_mem_a",
            type: "text",
  ...
  },
  {
    ...
    blurb:
      "Five spectrums. Put each marker where you think SEPA sits today, not where you'd like it to sit. Placing these fast is better than placing them carefully.",
    questions: [
      {
        id: "q16",
        prompt: "Today, SEPA sits where on each of these?",
        ...
        blocks: [
          ...
          },
          {
            id: "q16_d",
            type: "spectrum",
            leftLabel: "Known and understood",
            rightLabel: "Known but not understood",
            min: 0,
            max: 100,
            default: 50,
          },
    ...
    questions: [
      {
        ...
        blocks: [
          ...
          },
          {
            id: "q18_d",
            type: "text",
            label: "What is actually different, in one sentence?",
            placeholder: "Verbs, not metrics.",
            maxWords: 30,
          },
        ],
      },
      {
        ...
        helper:
          "So we can weight responses by vantage point. Nothing is attributed to you by name.",
        blocks: [
          {
            id: "respondent_name",
            type: "text",
